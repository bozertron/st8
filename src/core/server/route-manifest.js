...
const ROUTES = Object.freeze([
  ...
  { method: 'GET',  path: '/api/state', handler: '_handleServerState',
    auth: 'none',
    description: 'Server-state envelope: { status, uptime, targetDir, lastManifestUpdate, totalFiles }. Batch 032 (QW-3) — closes documented 404.' },
  { method: 'GET',  path: '/api/manifests', handler: '_handleManifestsList',
    auth: 'none',
    description: 'Schema-card index from file_registry + project healthScore. No buildGraph call (event-loop safe). Batch 032 (QW-3).' },
  { method: 'GET',  path: '/api/sonic/status', handler: '_handleSonicStatus',
    auth: 'none',
    description: 'Sonic daemon lifecycle state: { running, pid, port, host, since, restartCount, storePath, lastError }. Batch 032 — closes sonic-and-search.md roadmap P2.' },
